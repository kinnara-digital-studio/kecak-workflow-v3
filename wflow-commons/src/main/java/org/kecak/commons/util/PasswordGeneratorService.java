...
public class PasswordGeneratorService implements Serializable {
    ...
    public HashSalt createNewHashWithSalt(String password) throws NoSuchAlgorithmException, InvalidKeySpecException{
    ...
    public String hashPassword(PasswordSalt passwordSalt) throws NoSuchAlgorithmException, InvalidKeySpecException{
