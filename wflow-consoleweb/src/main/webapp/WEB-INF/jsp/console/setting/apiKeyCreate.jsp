...
<commons:popupHeader />
    ...
    <div id="main-body-content">
        <form:form id="createIncomingEmail" action="${pageContext.request.contextPath}/web/console/setting/apiKeys/submit" method="POST" commandName="incomingEmail" cssClass="form">
            ...
            <fieldset>
                ...
                <div class="form-row">
                    <label for="impersonates"><fmt:message key="console.setting.appKeys.common.label.impersonates"/></label>
                    <span class="form-input"><form:input path="impersonates" cssErrorClass="form-input-error"  size="30"/> *</span>
                </div>
                <div class="form-row">
                    <label for="remark"><fmt:message key="console.setting.appKeys.common.label.remark"/></label>
                    <span class="form-input"><form:input path="remark" cssErrorClass="form-input-error"  size="30" value="inbox"/> *</span>
                </div>
                <div class="form-row">
