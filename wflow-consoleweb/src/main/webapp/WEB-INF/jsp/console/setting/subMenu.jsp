...
<li id="nav-setting-api-keys"><a class="nav-link" href="${pageContext.request.contextPath}/web/console/setting/apiKeys"><span class="nav-steps"><i class="fas fa-key"></i></span><fmt:message key="console.header.submenu.label.setting.apiKeys"/></a></li>
