...
public abstract class DefaultSchedulerPlugin extends ExtDefaultPlugin implements SchedulerPlugin {
    /**
     * Return this method in {@link org.kecak.apps.app.model.DefaultSchedulerPlugin#filter(JobExecutionContext, Map)} to run this
     ...
     * {@link org.kecak.apps.app.model.DefaultSchedulerPlugin#everyHalfAnHour(JobExecutionContext)} or
     * {@link org.kecak.apps.app.model.DefaultSchedulerPlugin#everyHour(JobExecutionContext)} or
     * {@link org.kecak.apps.app.model.DefaultSchedulerPlugin#everyDay(JobExecutionContext)}
     *
     * @param context
     * @return
     */
