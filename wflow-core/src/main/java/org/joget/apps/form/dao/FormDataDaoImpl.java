...
public class FormDataDaoImpl extends HibernateDaoSupport implements FormDataDao {
    ...
    public FormRowSet find(String formDefId, String tableName, final String condition, final Object[] params, final String sort, final Boolean desc, final Integer start, final Integer rows) {
        ...
        return internalFind(orgId, entityName, newTableName, condition, params, sort, sortAs, desc, start, rows, false);
    }

    @Override
    public FormRowSet findAnyOrg(Form form, String condition, Object[] params, String sort, String sortAs, Boolean desc, Integer start, Integer rows, Boolean loadSoftDeleted) {
        final String entityName = getFormEntityName(form);
        final String tableName = getFormTableName(form);

        sortAs = FormUtil.PROPERTY_DATE_CREATED.equals(sort) || FormUtil.PROPERTY_DATE_MODIFIED.equals(sort) ? "timestamp" : sortAs;
        return internalFind(FORM_ANY_ORG_ID, entityName, tableName, condition, params, sort, sortAs, desc, start, rows, loadSoftDeleted);
    }

    @Override
    public FormRowSet findAnyOrg(String formDefId, String tableName, String condition, Object[] params, String sort, String sortAs, Boolean desc, Integer start, Integer rows, Boolean loadSoftDeleted) {
        final String entityName = getFormEntityName(formDefId);
        final String newTableName = getFormTableName(formDefId, tableName);

        sortAs = FormUtil.PROPERTY_DATE_CREATED.equals(sort) || FormUtil.PROPERTY_DATE_MODIFIED.equals(sort) ? "timestamp" : sortAs;
        return internalFind(FORM_ANY_ORG_ID, entityName, newTableName, condition, params, sort, sortAs, desc, start, rows, loadSoftDeleted);
    }
    ...
    public FormRowSet find(Form form, final String condition, final Object[] params, final String sort, final Boolean desc, final Integer start, final Integer rows) {
        ...
        return internalFind(orgId, entityName, tableName, condition, params, sort, sortAs, desc, start, rows, false);
    }
    ...
    protected void internalSoftDelete(String entityName, String tableName, String[] primaryKeyValues) {
        if (primaryKeyValues.length > 0) {
            ...
            String orgId = WorkflowUtil.getCurrentUserOrgId();
            FormRowSet rowSet = Optional.ofNullable(internalFind(orgId, entityName, tableName, condition, primaryKeyValues, null, null, null, null, null, false))
    ...
    public FormRowSet find(Form form, String condition, Object[] params, String sort, String sortAs, Boolean desc, Integer start, Integer rows, Boolean loadDeleted) {
        ...
        final String tableName = getFormTableName(form);
        final String orgId = WorkflowUtil.getCurrentUserOrgId();
        return internalFind(orgId, entityName, tableName, condition, params, sort, sortAs, desc, start, rows, loadDeleted);
    }
    ...
    public FormRowSet find(String formDefId, String tableName, String condition, Object[] params, String sort, String sortAs, Boolean desc, Integer start, Integer rows, Boolean loadDeleted) {
        ...
        final String newTableName = getFormTableName(formDefId, tableName);
        final String orgId = WorkflowUtil.getCurrentUserOrgId();
        return internalFind(orgId, entityName, newTableName, condition, params, sort, sortAs, desc, start, rows, loadDeleted);
    }
